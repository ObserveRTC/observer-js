...
interface CandidatePairElement {
...
interface LocalCandidateElement {
...
interface RemoteCandidateElement {
    candidateType?: CandidateType;
    deleted?: boolean;
    id?: string;
    ip?: string;
...
interface InboundRTPStatElement {
    bytesReceived?: number;
    codecId?: string;
...
interface OutboundRTPStatElement {
    bytesSent?: number;
    codecId?: string;
...
interface RemoteInboundRTPStatElement {
    codecId?: string;
    id?: string;
    jitter?: number;
    localId?: string;
...
interface UserMediaCallback {
    onMediaError: (errName: string) => void;
}

declare type Integration = 'General' | 'Janus' | 'Jitsi' | 'Mediasoup' | 'Medooze' | 'PeerJS' | 'Pion' | 'TokBox' | 'Twilio';
...
declare class ObserverPC {
    private readonly userConfig;
    private readonly _id;
    private readonly _timeZoneOffsetInMinute;
    private readonly _rtcState;
    constructor(userConfig: UserConfig);
    get id(): string;
    getPcDetails(marker?: string, browserId?: string): Promise<PCDetails>;
    get isExpired(): boolean;
    updateConnectionState(): void;
    getStats(): Promise<ObserverStats>;
}

declare type TransportType = 'local' | 'remote';
...
declare class Observer implements ClientCallback, UserMediaCallback {
    private readonly _initializeConfig;
    private readonly _userMediaHandler;
    private _rtcList;

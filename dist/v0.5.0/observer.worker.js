	...
	***************************************************************************** */
	...
	class ObserverProcessor {
	    constructor() {
	        ...
	        // @ts-expect-error Will be injected in build time
	        "0.5.0", 'from build date', 
	        // @ts-expect-error Will be injected in build time
	        "Thu, 14 Jan 2021 00:12:08 GMT");
	    }
	    get messageHandler() {
	    ...
	    onResponseRawStats(rawStats) {
	        ...
	        (_a = this._webSocketTransport) === null || _a === void 0 ? void 0 : _a.sendBulk(optimizedPayload);
	    }
	    onUserMediaError(mediaError) {
	        ...
	        (_a = this._webSocketTransport) === null || _a === void 0 ? void 0 : _a.send(socketPayloads);
	    }
	    ...
	    onResponseInitialConfig(rawStats) {

...
(function (global, factory) {
	...
	***************************************************************************** */
	...
	class ObserverPC {
	    ...
	    getPcDetails(marker, browserId) {
	        return __awaiter(this, void 0, void 0, function* () {
	            return {
	                'browserId': browserId !== null && browserId !== void 0 ? browserId : yield observerSingleton.getBrowserId(),
	...
	class RTCCollector {
	    ...
	    collectUserMediaError(errName) {
	        ...
	        return __awaiter(this, void 0, void 0, function* () {
	            return {
	                'details': {
	                    'browserId': (_a = this.browserId) !== null && _a !== void 0 ? _a : yield observerSingleton.getBrowserId(),
	                    'clientDetails': BrowserUtil.getClientDetails(),
	    ...
	    collectStats(observerPc) {
	        return __awaiter(this, void 0, void 0, function* () {
	            ...
	            const pcDetails = yield observerPc.getPcDetails(this.marker, this.browserId);
	            return {
	                'details': pcDetails,
	                stats
	            };
	...
	class Builder {
	    ...
	    withAccessToken(accessToken) {
	        this._initialConfig = Object.assign(Object.assign({}, this._initialConfig), accessToken && { accessToken });
	        return this;
	    }
	    build() {

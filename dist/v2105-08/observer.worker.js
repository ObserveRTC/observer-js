...
(function (factory) {
	...
	*/
	...
	class StatsMap {
	    ...
	    static track(stats) {
	        const { concealedSamples, concealmentEvents, detached, ended, framesDecoded, framesDropped, framesReceived, hugeFramesSent, frameWidth, frameHeight, id, insertedSamplesForDeceleration, jitterBufferDelay, jitterBufferEmittedCount, mediaSourceId, mediaType, remoteSource, removedSamplesForAcceleration, samplesDuration, silentConcealedSamples, totalSamplesReceived } = stats;
	        return {
	            concealedSamples,
	            concealmentEvents,
	            detached,
	...
	class StatsOptimizer {
	    ...
	    excludeSameCandidates(currentStats) {
	        ...
	        this.isSameLocalIceCandidate(previousStats, currentStats) && omitList.push('iceStats.localCandidates');
	        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
	        this.isSameLocalIceCandidate(previousStats, currentStats) && omitList.push('iceStats.remoteCandidates');
	        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
	        this.isSameClientDetails(previousStats, currentStats) && omitList.push('clientDetails');
	        // eslint-disable-next-line @typescript-eslint/no-unused-expressions
	        this.isSameDeviceList(previousStats, currentStats) && omitList.push('deviceList');
	        // eslint-disable-next-line @typescript-eslint/no-unsafe-call,@typescript-eslint/no-unsafe-member-access
	        const retval = lodash.omit(currentStats, omitList);
	        return retval;
	    }
	    ...
	    isSameLocalIceCandidate(previousStats, currentStats) {
	        var _a, _b;
	        return this.isEqual((_a = previousStats.iceStats) === null || _a === void 0 ? void 0 : _a.localCandidates, (_b = currentStats.iceStats) === null || _b === void 0 ? void 0 : _b.localCandidates);
	    }
	    isSameRemoteIceCandidate(previousStats, currentStats) {
	        var _a, _b;
	        return this.isEqual((_a = previousStats.iceStats) === null || _a === void 0 ? void 0 : _a.remoteCandidates, (_b = currentStats.iceStats) === null || _b === void 0 ? void 0 : _b.remoteCandidates);
	    }
	    isSameClientDetails(previousStats, currentStats) {
	        return this.isEqual(previousStats.clientDetails, currentStats.clientDetails);
	    }
	    isSameDeviceList(previousStats, currentStats) {
	        return this.isEqual(previousStats.deviceList, currentStats.deviceList);
	    }
	    isEqual(previousStats, currentStats) {
	        // eslint-disable-next-line @typescript-eslint/no-unsafe-call,@typescript-eslint/no-unsafe-member-access
	        return lodash.isEqual(previousStats, currentStats);
	    }
	    removeOldBulk() {
	...
	***************************************************************************** */
	...
	class WebSocketTransport {
	    constructor(wsServerAddress, accessToken) {
	        ...
	        const serverUrl = this.serverAddress(wsServerAddress, accessToken);
	        this._webSocket = new ReconnectingWebSocket(serverUrl, [], options);
	    ...
	    serverAddress(wsServerAddress, accessToken) {
	        if (!accessToken) {
	...
	class ObserverProcessor {
	    ...
	    startWsServer(wsServerAddress, accessToken) {
	        ...
	        this._webSocketTransport = new WebSocketTransport(wsServerAddress, accessToken);
	    }

    ...
    onResponseRawStats (rawStats: RawStats[]): void {
        ...
        const socketPayloads = filteredStats.map((currentStats) => {
            const payload = {
                ...
                'receiverStats': RawStatsProcessor.getSendRecvStats(currentStats.stats.receiverStats as unknown as SendRecv[]),
                'senderStats': RawStatsProcessor.getSendRecvStats(currentStats.stats.senderStats as unknown as SendRecv[]),

...
export class PeerConnection extends Message<PeerConnection> {
	...
	static readonly fields: FieldList = proto2.util.newFieldList(() => [
		...
		},
		{
			...
			kind: 'message',
			T: Samples_ClientSample_IceCandidatePair,
			repeated: true,
		},
	]);
	...
	static equals(
		a: PeerConnection | PlainMessage<PeerConnection> | undefined,
		b: PeerConnection | PlainMessage<PeerConnection> | undefined
	): boolean {
...
export class InboundTrack extends Message<InboundTrack> {
	...
	static equals(
		a: InboundTrack | PlainMessage<InboundTrack> | undefined,
		b: InboundTrack | PlainMessage<InboundTrack> | undefined
	): boolean {
...
export class OutboundTrack extends Message<OutboundTrack> {
	...
	static equals(
		a: OutboundTrack | PlainMessage<OutboundTrack> | undefined,
		b: OutboundTrack | PlainMessage<OutboundTrack> | undefined
	): boolean {
...
export class SfuTransport extends Message<SfuTransport> {
	...
	static equals(
		a: SfuTransport | PlainMessage<SfuTransport> | undefined,
		b: SfuTransport | PlainMessage<SfuTransport> | undefined
	): boolean {
...
export class SfuInboundRtpPad extends Message<SfuInboundRtpPad> {
	...
	static equals(
		a: SfuInboundRtpPad | PlainMessage<SfuInboundRtpPad> | undefined,
		b: SfuInboundRtpPad | PlainMessage<SfuInboundRtpPad> | undefined
	): boolean {
...
export class SfuOutboundRtpPad extends Message<SfuOutboundRtpPad> {
	...
	static equals(
		a: SfuOutboundRtpPad | PlainMessage<SfuOutboundRtpPad> | undefined,
		b: SfuOutboundRtpPad | PlainMessage<SfuOutboundRtpPad> | undefined
	): boolean {
...
export class SfuSctpChannel extends Message<SfuSctpChannel> {
	...
	static equals(
		a: SfuSctpChannel | PlainMessage<SfuSctpChannel> | undefined,
		b: SfuSctpChannel | PlainMessage<SfuSctpChannel> | undefined
	): boolean {
